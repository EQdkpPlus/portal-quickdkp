 ...
 * -----------------------------------------------------------------------
 * Began:       2008
 * Date:        $Date: 2009-03-24 15:15:21 +0100 (Di, 24. Mrz 2009) $
 * -----------------------------------------------------------------------
 ...
 * @version     $Rev: 4386 $
 * 
 * $Id: module.php 4386 2009-03-24 14:15:21Z osr-corgan $
 */
...
if(!function_exists(quickdkp_module)){
  function quickdkp_module(){
    global $user, $db, $eqdkp, $dkpplus, $html,$conf_plus,$tpl, $plang;
